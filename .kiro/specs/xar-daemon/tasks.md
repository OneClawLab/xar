...
- [x] 1.1 Set up project structure and core types
...
- [x]* 1.9 Write property test for graceful shutdown
...
- [x] 2.1 Implement Agent initialization (xar init)
...
- [x]* 2.13 Write property test for log entry presence
...
- [x]* 3.5 Write property test for message persistence round-trip
  - **Property 4: Message Persistence Round-trip**
  - **Validates: Requirements 6.3, 6.4**

- [x] 3.6 Implement Context Builder
...
- [x]* 3.7 Write property test for context assembly completeness
  - **Property 5: Context Assembly Completeness**
  - **Validates: Requirements 7.2, 7.3**

- [x] 3.8 Implement IpcChunkWriter for token streaming
  - Create `src/daemon/ipc-chunk-writer.ts` extending Writable
  - Send stream_token messages for each token
  - _Requirements: 8.1, 8.2_

- [x]* 3.9 Write property test for token streaming reconstruction
  - **Property 6: Token Streaming Reconstruction**
  - **Validates: Requirements 8.2**

- [x] 3.10 Implement LLM call integration with pai library
...
- [x] 3.11 Implement streaming message delivery
...
- [x]* 3.12 Write property test for streaming message format validity
  - **Property 12: Streaming Message Format Validity**
  - **Validates: Requirements 14.4**

- [x] 3.13 Implement LLM response persistence
...
- [x]* 3.14 Write property test for batch message atomicity
  - **Property 7: Batch Message Atomicity**
  - **Validates: Requirements 10.3**

- [x] 3.15 Implement LLM retry logic with exponential backoff
  - Distinguish transient vs permanent errors
  - Retry transient errors up to max_attempts
  - Write error records for permanent errors
  - _Requirements: 13.1, 13.2, 13.3, 13.4_

- [x]* 3.16 Write property test for retry exponential backoff
  - **Property 10: Retry Exponential Backoff**
  - **Validates: Requirements 13.1**

- [x] 3.17 Checkpoint - Ensure all tests pass
  - Ensure all tests pass, ask the user if questions arise.

### Phase 4: Memory Management and Advanced Features

- [x] 4.1 Implement session-level memory compression
...
- [x]* 4.2 Write property test for memory compression idempotence
  - **Property 8: Memory Compression Idempotence**
  - **Validates: Requirements 11.1, 11.3**

- [x] 4.3 Implement Memory Processor for cross-session memory
...
- [x] 4.4 Implement Cron Scheduler for periodic memory updates
...
- [x] 4.5 Implement System Agents initialization
...
- [x]* 4.6 Write property test for system agent initialization
  - **Property 17: System Agent Initialization**
  - **Validates: Requirements 20.1, 20.2**

- [x] 4.7 Implement Agent status consistency tracking
  - Track agent status transitions (stopped ↔ started)
  - Update config.json on status changes
  - _Requirements: 3.2, 3.3, 3.5, 3.6_

- [x]* 4.8 Write property test for agent status consistency
  - **Property 3: Agent Status Consistency**
  - **Validates: Requirements 3.2, 3.3, 3.5, 3.6**

- [x] 4.9 Implement Agent status initialization
  - Set status to 'stopped' on init
  - _Requirements: 2.4_

- [x]* 4.10 Write property test for agent status initialization
  - **Property 19: Agent Status Initialization**
  - **Validates: Requirements 2.4**

- [x] 4.11 Implement Environment variable override
  - Apply THECLAW_HOME, XAR_IPC_PORT, XAR_LOG_LEVEL throughout
  - _Requirements: 18.1, 18.2, 18.3_

- [x]* 4.12 Write property test for environment variable override
  - **Property 15: Environment Variable Override**
  - **Validates: Requirements 18.1, 18.2, 18.3**

- [x] 4.13 Implement Exit code correctness
  - Return 0 for success
  - Return 1 for runtime errors
  - Return 2 for usage errors
  - _Requirements: 19.1, 19.2, 19.3_

- [x]* 4.14 Write property test for exit code correctness
...
- [x] 4.17 Final checkpoint - All tests pass
  - Ensure all tests pass, ask the user if questions arise.
